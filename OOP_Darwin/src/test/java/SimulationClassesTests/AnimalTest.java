...
//        assertEquals(mockGenes, customAnimal.getGenes());
//    }
//
//    @Test
...
//
//    @Test
//    void testActionBounded_Eat() {
//        Grass mockPlant = new Grass();
//        Mockito.when(mockPlant.getEnergy()).thenReturn(50);
//
//        defaultAnimal.actionBounded(boundary, null, true, mockPlant);
//        assertEquals(200, defaultAnimal.getEnergyLevel()); // 150 + 50 = 200
//    }
//
//    @Test
//    void testActionBounded_Mate() {
//        Animal mateAnimal = Mockito.mock(Animal.class);
//        Mockito.when(mateAnimal.getEnergyLevel()).thenReturn(150);
//
...
//    @Test
//    void testEquals() {
//        assertTrue(defaultAnimal.equals());
//    }
}
